...
links.forEach(function (link) {
    link.addEventListener('click', () => {
        document.querySelector('.leftPart ul li.checked').classList.remove('checked');
        link.classList.add('checked');
        document.querySelector('.rightPart .rightPart-inner .portfolio-section.active').classList.remove('active');
